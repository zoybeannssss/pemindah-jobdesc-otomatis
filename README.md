...
# upload semua job desc lama setelah selesai milih file klik open
# tunggu sampai semua file ter-upload

# setelah sudah ter-upload, select dan klik kanan folder "main.py" 
# select "open in intergrated terminal"
"di kolom "Termina" ketik kata-kata berikut
